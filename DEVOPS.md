...
- [ ] Vérifier que prisma est dans dependencies

### Avant chaque déploiement

- [ ] Build local réussi : `npm run build`
- [ ] Tests Prisma : `npx prisma generate && npx prisma db push`
- [ ] Variables d'environnement à jour dans Azure Portal
...
**Stack testée** : Node.js 22 LTS, Prisma 6.1.0, Fastify 5.2.0, Azure App Service Linux
